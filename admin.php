  ...
  <div class="container">
    <section>
      ...
      <form action="" method="post" class="add-product-form" enctype="multipart/form-data">
        ...
        <input type="text" name="p_name" placeholder="enter the product price" class="box" required>
        <input type="number" name="p_price" min="0" placeholder="enter the product name" class="box" required>
        ...
        <tbody>
          ...
          ?>
              ...
              <tr>
                ...
                <td>$<?= $row['price']; ?>/-</td>
                <td>
                  <a href="admin.php?delete=<?= $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure?')">
                    <i class="fas-trash"></i>delete
                  </a>
                  <a href="admin.php?edit=<?= $row['id']; ?>" class="option-btn">
