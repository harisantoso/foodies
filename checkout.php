...
if (isset($_POST['order_btn'])) {
  ...
  if ($cart_query && $detail_query) {
    ...
    <div class='customer-details'>
      ...
      <p>your numbaer: <span>" . $number . "</span></p>
...
<body>
  ...
  <div class="container">
    ...
    <section class="checkout-form">
      ...
      <h1 class="heading">comlete your order</h1>
      ...
      <form action="" method="post">
        ...
        <div class="flex">
          ...
          <div class="inputBox">
            ...
            <input type="text" placeholder="e.g flat" name="flat" required>
          </div>

          <div class="inputBox">
            <span>address line 2</span>
            <input type="text" placeholder="e.g street" name="street" required>
          </div>
          ...
          <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g jawabarat" name="state" required>
          </div>
